...
# REVISED DATE: 
# PURPOSE: Create the function print_results that prints the results statistics 
#          from the results statistics dictionary (results_stats_dic). It should 
#          also allow the user to print out cases of misclassified dogs and cases 
#          of misclassified breeds of dog using the Results dictionary (results_dic).  
...
#       below by the function code specified in the docstring comments above.
