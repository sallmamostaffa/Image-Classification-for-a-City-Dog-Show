...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("{:25}: {:3}".format('Total Images', results_stats_dic['n_images']))
    
    # Print total number of dog images
    print("{:25}: {:3}".format('Dog Images', results_stats_dic['n_dogs_img']))
    
    # Print total number of "not-a-dog" images
    print("{:25}: {:3}".format('Not-a-Dog Images', results_stats_dic['n_notdogs_img']))
    
    # Print summary statistics (percentages)
    print("\n*** Summary Statistics ***")
    for key in results_stats_dic:
        if key.startswith('p'):
            print("{:25}: {:.1f}%".format(key, results_stats_dic[key]))
